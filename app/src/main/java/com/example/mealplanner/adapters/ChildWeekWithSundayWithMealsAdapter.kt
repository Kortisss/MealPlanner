...
class ChildWeekWithSundayWithMealsAdapter(private val list:List<SundayWithMeals>) : RecyclerView.Adapter<ChildWeekWithSundayWithMealsAdapter.SundayViewHolder>() {
    inner class SundayViewHolder(private val binding: SectionRowBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(
        ...
        return SundayViewHolder(SectionRowBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
